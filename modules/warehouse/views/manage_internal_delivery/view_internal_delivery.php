            ...
            <div class="col-md-12 panel-padding">
              <table class="table border table-striped table-margintop">
                <tbody>
                  ...
                  <?php if ($internal_delivery->approval == 1) { ?>
                        ...
                        <ul class="dropdown-menu dropdown-menu-right menu-width-height">
                          ...
                          <li>
                            <div class="row text-right col-md-12">
                              ...
                              <a href="#" data-loading-text="<?php echo _l('wait_text'); ?>" onclick="deny_request(<?php echo html_entity_decode($internal_delivery->id); ?>); return false;" class="btn btn-warning"><?php echo _l('deny'); ?></a>
                            </div>
                          </li>
                        </ul>
                      </div>
