      ...
      <div class="col-md-12">
       ...
       <div class="row all_filters">
        ...
        if(has_permission('fixed_equipment_requested', '', 'view') || is_admin()){ ?>
          <div class="col-md-3">
            <?php
            $checkout_for = get_module_filter($module_name, 'checkout_for');
            $checkout_for_filter_val = !empty($checkout_for) ? explode(",", $checkout_for->filter_value) : [];
            echo render_select('checkout_for_filter[]', $staffs, array('staffid', array('firstname', 'lastname')), 'fe_checkout_for', $checkout_for_filter_val, array('multiple' => true, 'data-actions-box' => true),[],'','',false);
            ?>
          </div>
        <?php }  ?>
        ...
        <div class="col-md-3">
          ...
          echo render_date_input('create_from_date_filter', 'fe_create_from_date', $from_date_filter_val);
          ?>
        </div>
        ...
        <div class="col-md-3">
          ...
          echo render_date_input('create_to_date_filter', 'fe_create_to_date', $to_date_filter_val);
          ?>
        </div>
