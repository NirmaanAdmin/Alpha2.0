                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group select-placeholder" id="form_contact_w">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <?php echo render_input('name', 'form_settings_to', '', 'text', ['disabled' => true]); ?>
                                    </div>
                                    <div class="col-md-6">
                                        <?php echo render_input('email', 'form_settings_email', '', 'email', ['disabled' => true]); ?>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
