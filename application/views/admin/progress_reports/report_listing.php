...
<div id="wrapper">
    <div class="content">
        <?php if (!empty($missing_dpr_projects)) { ?>
            <style>
                .dpr-alert {
                    overflow: hidden;
                    white-space: nowrap;
                ...
                .dpr-alert-content {
                    ...
                    padding-left: 100%;
                    animation: dpr-scroll 25s linear infinite;
                }

                .dpr-alert-content:hover {
                    animation-play-state: paused;
                }

                @keyframes dpr-scroll {
                    from {
            ...
            <div class="alert alert-warning" style="padding:8px 15px; margin-bottom:15px; overflow:hidden; white-space:nowrap;">
                <marquee behavior="scroll" direction="left" scrollamount="6">
                    <strong>
                        <i class="fa fa-exclamation-triangle"></i>
                        DPR NOT RECORDED FOR <?php echo date('d M Y', strtotime('-1 day')); ?> :
                    </strong>

                    <?php foreach ($missing_dpr_projects as $project) { ?>
                        <span style="margin-right:40px;">
                            <strong><?php echo e($project['name']); ?></strong> - DPR not recorded
                        </span>
                    <?php } ?>
                </marquee>
            </div>
